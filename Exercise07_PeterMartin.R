...
write.table(x=iris,file="iris.txt",sep="\t",quote=F,row.names = FALSE) # Generates a tab-delimited .txt file from the read
...
list1=list(vec1,df1,number,mat1,vec2) # Combines all elements above into one list of length 5